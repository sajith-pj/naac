    ...
    if (isValid) {
      ...
      axios
        ...
        .catch((error) => {
          setLoader(false);
          toast.error(
            "Something went wrong, Please check Token Code and Password",
            {
              position: "top-right",
              autoClose: 3000,
              hideProgressBar: true,
    ...
    <div className="login-container">
      ...
      <div className="login-left">
        <div className="login-form">
          ...
          <div className="head">
            <h4>{confirmPassword ? "Reset Password" : "Forgot Password"}</h4>
          </div>
          {confirmPassword && (
            <div className="head">
              <span className="text-secondary" style={{ fontSize: "13px" }}>
                **Enter the Password reset code recieved on email and set new
                password!
              </span>
            </div>
          )}
