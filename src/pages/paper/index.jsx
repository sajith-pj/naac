...
function Paper() {
  ...
  const deletePaper = () => {
    Swal.fire({
      ...
      if (result.isConfirmed) {
        setUpdating(true);
        axios
          .delete(`/programs/subjects/details/${inputValues?.id}`, {})
          .then(() => {
  ...
  const submitPaper = () => {
    ...
    if (Object.values(errObj).some((val) => val !== "")) {
      ...
      setUpdating(true);
      axios
        .put(`/programs/subjects/details/${inputValues?.id}`, inputValues)
        .then((response) => {
      ...
      setUpdating(true);
      axios
        .post("/programs/subjects/list", inputValues)
        .then((response) => {
  ...
  return (
    <Row>
      <div className="pagetitle">
        ...
        <nav>
          <ol className="breadcrumb">
            ...
            <li className="breadcrumb-item active">Papers</li>
          </ol>
        </nav>
      </div>
      ...
      <ModalCom
        open={open}
        title={`${inputValues?.id ? "Update Paper" : "Add Paper"}`}
        toggle={closeModal}
      >
        <ModalBody>
          <Row>
              ...
              <FormGroup>
                ...
                >
                  ...
                  {departmentList.map((department, ky) => (
                    <option key={ky} value={department.id}>
                      {" "}
                      {department.name}{" "}
                    </option>
                  ))}
              ...
              <FormGroup>
                ...
                >
                  ...
                  {programList.map((program, ky) => {
                    if (program.department == inputValues?.department) {
                      return (
