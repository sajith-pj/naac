...
function Department() {
  ...
  const submitDepartment = () => {
    ...
    if (Object.values(errObj).some((val) => val !== "")) {
      ...
      setUpdating(true);
      axios
        .put(`/programs/department/details/${inputValues?.id}`, inputValues)
        .then((response) => {
      ...
      setUpdating(true);
      axios
        .post("/programs/department/list", inputValues)
        .then((response) => {
  ...
  const deleteDepartment = () => {
    Swal.fire({
      ...
      if (result.isConfirmed) {
        setUpdating(true);
        axios
          .delete(`/programs/department/details/${inputValues?.id}`, {})
          .then(() => {
  ...
  return (
    <Row>
      ...
      <ModalCom
        open={open}
        title={`${inputValues?.id ? "Update Department" : "Add Department"}`}
        toggle={closeModal}
      >
        <ModalBody>
          <Row>
