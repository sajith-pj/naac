  ...
  return (
    <>
      <Row>
        ...
        <Col xs="12" sm="6" md="3" className="mt-2 d-flex">
          <Button
      ...
      <ModalCom open={isModalOpen} title={"Upload Bulk"} toggle={closeModal}>
        <ModalBody>
          <form>
            <FormGroup>
              <Label htmlFor="student-file">
                Please select a file to upload bulk amount of student data
              </Label>
              <Input
                type="file"
                name="student-file"
