        ...
        <div className="pagetitle">
          ...
          <nav>
            <ol className="breadcrumb">
              ...
              <li className="breadcrumb-item active">Criterions</li>
            </ol>
          </nav>
        </div>
      </Col>
            ...
            <table className="naac-table">
              <tbody className="blue-rows">
                {subCriteriaList.map((val, ky) => {
                  if (
                    selectedCriteriaHead === "All" ||
                    val.criterion.includes(selectedCriteriaHead)
                  ) {
                    return (
