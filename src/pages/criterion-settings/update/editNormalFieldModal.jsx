...
function EditNormalFieldModal({
  showUpdateNormalFieldModal,
  ...
  const updateField = () => {
    let err = {
      minimum: ["text", "textarea"].includes(value.type)
        ? isRequired(value.minimum)
        : "",
      maximum: ["text", "textarea"].includes(value.type)
        ? isRequired(value.maximum)
        : "",
      selectBoxOptions: ["select_box", "select box"].includes(value?.type)
        ? value?.selectBoxOptions.length === 0
  ...
  return (
    <ModalCom
      open={showUpdateNormalFieldModal}
      title={"Update Field"}
      toggle={closeUpdateNormalFieldModal}
    >
      <ModalBody>
        <Row>
          <Col xs="12">
          ...
          <Col xs="4">
            <Input
              ...
              onChange={handleChange}
            />
            <Label htmlFor="editable" className="ms-1">
              Editable
            </Label>
          </Col>
        </Row>
      ...
      <ModalFooter>
        <Button size="sm" outline onClick={closeUpdateNormalFieldModal}>
          Close
        </Button>
        <Button size="sm" color="primary" onClick={updateField}>
          Update
        </Button>
      </ModalFooter>
    </ModalCom>
