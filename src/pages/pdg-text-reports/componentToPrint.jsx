...
const ComponentToPrint = React.forwardRef((props, ref) => {
  ...
  const imageData = (obj) => {
    if (obj !== null && checkURL(obj)) {
      return <img className="report-image" src={obj} alt="" />;
    } else if (obj !== null) {
      return (
        <Document
          file={obj}
