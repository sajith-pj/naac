...
function Programs() {
  ...
  const deleteProgram = () => {
    Swal.fire({
      ...
      if (result.isConfirmed) {
        setUpdating(true);
        axios
          .delete(`/programs/programs/details/${inputValues?.id}`, {})
          .then(() => {
  ...
  const submitProgram = () => {
    ...
    if (Object.values(errObj).some((val) => val !== "")) {
      ...
      setUpdating(true);
      axios
        .put(`/programs/programs/details/${inputValues?.id}`, inputValues)
        .then((response) => {
      ...
      setUpdating(true);
      axios
        .post("/programs/programs/list", inputValues)
        .then((response) => {
  ...
  return (
    <Row>
      ...
      <ModalCom
        open={open}
        title={`${inputValues?.id ? "Update Program" : "Add Program"}`}
        toggle={closeModal}
      >
        <ModalBody>
          <Row>
