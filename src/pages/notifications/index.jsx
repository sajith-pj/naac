...
function Notifications() {
  ...
  const viewUrl = (notification) => {
    if (notification?.status === "ADMIN_MSG") {
      if (notification?.url) window.open(`${notification.url}`, "_blank");
    } else {
      window.open(
        `/criterion/details/view/${notification?.id}/${notification?.criterion}`,
        "_blank"
      );
    }
  };
  ...
  const changeStatus = (notification, mode) => {
    ...
    axios
      .put(`/user/notifications/details/${notification?.id}`, reqBody)
      .then((response) => {
                      ...
                      <tr key={ky}>
                        ...
                        <td>
                          ...
                          <DeleteIcon
                            ...
                            onClick={() => changeStatus(val, "delete")}
                          />{" "}
                        </td>
                      </tr>
                    );
