...
function Events() {
        ...
        return (
          <>
            {rowData?.images ? (
              ...
              >
                <p className="view_p">View Image</p>{" "}
              </a>
            ) : (
              "-"
            )}
  ...
  const submitEvent = () => {
    ...
    if (Object.values(errObj).some((val) => val !== "")) {
      ...
      axios
        .put(`/programs/events/details/${inputValues?.id}`, formData)
        .then((response) => {
      ...
      axios
        .post("/programs/events/list", formData)
        .then((response) => {
  ...
  const deleteEvent = () => {
    Swal.fire({
      ...
      if (result.isConfirmed) {
        setDeleting(true);
        axios
          .delete(`/programs/events/details/${inputValues.id}`, {
            headers: {
  ...
  return (
    <Row>
      ...
      <ModalCom
        open={open}
        title={`${inputValues?.id ? "Update Event" : "Add Event"}`}
        toggle={closeModal}
      >
        <ModalBody>
          <Row>
