...
const CriterionSettings = React.lazy(() =>
  import("./pages/criterion-settings")
);
const AddCriterion = React.lazy(() =>
  import("./pages/criterion-settings/addCriterion")
);
...
const AddCriterionDetails = React.lazy(() =>
  import("./pages/all-criterions/addDetails")
);
const AddCriterionSecond = React.lazy(() =>
  import("./pages/criterion-settings/AddCriterionSecond")
);
const ViewCriterion = React.lazy(() =>
  import("./pages/all-criterions/viewCriterion")
);
const UpdateCriterion = React.lazy(() =>
  import("./pages/criterion-settings/update")
);
...
const SelectBoxList = React.lazy(() => import("./pages/SelectBoxList"));
function MainRoute() {
  return (
    <Suspense fallback={<SuspenseLoader />}>
      <Routes>
        ...
        <Route
          path="/terms-conditions/:agreementType"
          element={<Agreement />}
        />
        <Route path="/" element={<Layout />}>
          ...
          <Route path="select-box" element={<SelectBoxList />} />
          ...
          <Route
            path="criterion-settings/update/:id"
            element={<UpdateCriterion />}
          />
          <Route path="add-fields" element={<UpdateCriterion />} />
          <Route path="add-criterion" element={<AddCriterion />}>
            <Route path=":id" element={<AddCriterion />} />
          </Route>
          ...
          <Route
            path="criterion/add-details/:id"
            element={<AddCriterionDetails />}
          />
          <Route
            path="criterion/update-details/:id/:data_id"
            element={<AddCriterionDetails />}
          />
          <Route
            path="criterion/details/view/:id/:criterion_id"
            element={<ViewCriterion />}
          />
