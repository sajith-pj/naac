                    ...
                    {searchrResults.length > 0
                      ? searchrResults.map((res, k) => {
                          return (
                            ...
                            >
                              <p>
                                <span>{res?.criterion} - </span> {res?.question}
                              </p>
                            </div>
                          );
                        })
            ...
            <nav className="header-nav ms-auto">
              <ul className="d-flex align-items-center">
                      ...
                      !hide && (
                        <li className="nav-item dropdown pe-3">
                          ...
                          <ul className="dropdown-menu dropdown-menu-end dropdown-menu-arrow profile">
                            ...
                            {userScopeClubs.length > 0
                              ? userScopeClubs.map((val, ky) => {
                                  return (
                                    <li
                                      key={ky}
                                      onClick={() => changeScope("CLUB", val)}
                                    >
                                      <a
                                        href="javascript:void(0)"
                                        className="dropdown-item d-flex align-items-center"
                ...
                {user?.user_scope == "ADMIN" && (
                  <li className="nav-item dropdown">
                    <span
                      style={{ background: "#cff4fc", borderRadius: "10px" }}
                      className="nav-link nav-icon"
                    >
                      <img src={versionIcon} width="18" className="me-2" />
                      <span className="fs-6 fw-bold">
                        {ctx.permissions.input_version}
                      </span>
                    </span>
                  </li>
                )}
                <li className="nav-item dropdown pe-3">
                  ...
                  >
                    ...
                    <span style={{ fontSize: "22px", marginBottom: "7px" }}>
